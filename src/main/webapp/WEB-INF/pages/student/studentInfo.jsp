    ...
    <div id="adminImg">
        ...
        <div id="inputImgDiv"  style="display:none">
            <div class="form-inline" role="form">
                ...
                <button type="button" onclick="submitImg('${studentID}','${pageContext.request.contextPath}/student/studentChangeImg.do')" class="btn btn-default btn-sm">提交
                </button>
            </div>
        </div>
    </div>
    <div id="infomation">
        <div id="tabDiv">
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    <td>姓名</td>
                    <td><span id="studentName">${studentName}</span></td>
                </tr>
                <tr>
                    <td>手机号</td>
                    <td><span id="studentPhonenumber">${studentPhonenumber}</span></td>
                </tr>
                <tr>
                    <td>ID</td>
                    <td><span id="studentID">${studentID}</span></td>
                </tr>
                <tr>
                    <td>单位</td>
                    <td><span id="studentDepartment">${studentDepartment}</span></td>
                </tr>
                <tr>
                    <td>密码</td>
                    <td>
            ...
            <div id="changePwdDiv" style="display:none">
                ...
                <div role="form" id="changePwdForm" name="changePwdForm" class="form-horizontal" action="changePwd"
                    ...
                    <div class="input-group col-sm-offset-2 col-sm-8" id="btnGroup">
                        <button onclick="SubmitchangePwd('${studentID}','${pageContext.request.contextPath}/student/modifyPassword.do')"
