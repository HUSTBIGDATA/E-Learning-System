    ...
    <div id="videoHeader">
        <div id="myCarousel" class="carousel slide" style="interval:1000">
            ...
            <div class="carousel-inner">
                ...
                <div class="item">
                    <img src="<%=basePath%>statics/img/4.jpg" alt="Third slide" class="scollimg">
                    <div class="carousel-caption">第四张图</div>
                </div>
            </div>
            <!-- 轮播（Carousel）导航 -->
        ...
        <table id="vido">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <a href="<%=basePath%>/public/videoPlay.html" target="_blank"> <img src="<%=basePath%>statics/img/4.jpg" alt="视频截图"
                                                                                       class="vdoName"></a>
                                    </td>
                                    <td>
                                        <textarea class="realName" disabled>第二个视频</textarea>
                                        <img src="<%=basePath%>statics/img/4.jpg.jpg" alt="视频截图" class="vdoName">
                                    </td>
                                    <td>
                                        <textarea class="realName" disabled>第三个视频</textarea>
                                        <img src="<%=basePath%>statics/img/4.jpg" alt="视频截图" class="vdoName">
                                    </td>
                                    <td>
            ...
            <tr>
                <td>
                    <div class="videoClass">
                        <div class="videpClassTitle">
                            <h3><span class="titleLeft">人工智能</span></h3>
                            <a href="#"><span class="titleRight">查看更多>></span></a>
            ...
            <tr>
                <td>
                    <div class="videoClass">
                        <div class="videpClassTitle">
                            <h3><span class="titleLeft">神经网络</span></h3>
                            <a href="#"><span class="titleRight">查看更多>></span></a>
